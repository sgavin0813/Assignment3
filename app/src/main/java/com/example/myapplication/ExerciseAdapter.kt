...
lateinit var varListener: ExerciseListAdapter.OnItemClickListener
...
class ExerciseListAdapter(private var dataList: List<ExerciseData>):
    ...
    override fun onBindViewHolder(holder: ExerciseViewHolder, position: Int) {
        ...
        holder.exerciseName.text = individualExercise.name
        holder.exerciseGroup.text = individualExercise.group
        holder.exerciseImage.setImageResource(individualExercise.image)
    }
}